...
OpeningTime.create({ vacation: false, day: 6, open:  800, close: 1800, schedule: cafe_schedule })
OpeningTime.create({ vacation: false, day: 7, open: 1100, close: 1500, schedule: cafe_schedule })

OpeningTime.create({ vacation: false, day: 1, open: 1130, close: 2300, schedule: bridge_schedule })
...
OpeningTime.create({ vacation: false, day: 6, open:  800, close: 1800, schedule: bridge_schedule, service_start: 930 })
OpeningTime.create({ vacation: false, day: 7, open: 1130, close: 2300, schedule: bridge_schedule })

OpeningTime.create({ vacation: true, day: 2, open:  930, close: 1530, schedule: bridge_schedule })
OpeningTime.create({ vacation: true, day: 3, open:  930, close: 1500, schedule: bridge_schedule })
...
OpeningTime.create({ vacation: true, day: 6, open:  930, close: 1530, schedule: bridge_schedule })

OpeningTime.create({ vacation: false, day: 1, open: 1130, close: 2300, schedule: stags_schedule })
...
OpeningTime.create({ vacation: false, day: 4, open: 1130, close: 2400, schedule: stags_schedule })
OpeningTime.create({ vacation: false, day: 5, open: 1130, close:  100, schedule: stags_schedule })
OpeningTime.create({ vacation: false, day: 6, open: 1130, close: 2400, schedule: stags_schedule })
OpeningTime.create({ vacation: false, day: 7, open: 1130, close: 2400, schedule: stags_schedule })

OpeningTime.create({ vacation: false, day: 1, open: 1100, close: 1530, schedule: shop_schedule })
...
OpeningTime.create({ vacation: false, day: 6, open:  800, close: 1900, schedule: shop_schedule })
OpeningTime.create({ vacation: false, day: 7, open: 1000, close: 1600, schedule: shop_schedule })
...
OpeningTime.create({ vacation: true, day: 6, open:  830, close: 1630, schedule: shop_schedule })